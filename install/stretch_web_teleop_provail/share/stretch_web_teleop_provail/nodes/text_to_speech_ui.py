...
# Local Imports
from stretch_web_teleop_provail.msg import TextToSpeech
...
if __name__ == "__main__":
    ...
    config_share_dir = os.path.join(
        get_package_share_directory("stretch_web_teleop_provail"),
        "config",
    )
    config_src_dir = os.path.expanduser("~/provail_ws/src/stretch_web_teleop_provail/config")
