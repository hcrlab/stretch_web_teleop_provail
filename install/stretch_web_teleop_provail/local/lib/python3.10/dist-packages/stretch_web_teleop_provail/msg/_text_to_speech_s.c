...
bool stretch_web_teleop_provail__msg__text_to_speech__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("stretch_web_teleop_provail.msg._text_to_speech.TextToSpeech", full_classname_dest, 59) == 0);
  }
  stretch_web_teleop_provail__msg__TextToSpeech * ros_message = _ros_message;
  {  // text
...
PyObject * stretch_web_teleop_provail__msg__text_to_speech__convert_to_py(void * raw_ros_message)
{
  ...
  {
    PyObject * pymessage_module = PyImport_ImportModule("stretch_web_teleop_provail.msg._text_to_speech");
