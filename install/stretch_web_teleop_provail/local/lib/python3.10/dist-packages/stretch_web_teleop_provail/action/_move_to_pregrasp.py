...
class Metaclass_MoveToPregrasp_Goal(type):
    ...
    def __import_type_support__(cls):
        try:
            ...
            module = import_type_support('stretch_web_teleop_provail')
        except ImportError:
            import logging
            import traceback
            logger = logging.getLogger(
                'stretch_web_teleop_provail.action.MoveToPregrasp_Goal')
            logger.debug(
...
class Metaclass_MoveToPregrasp_Result(type):
    ...
    def __import_type_support__(cls):
        try:
            ...
            import traceback
            logger = logging.getLogger(
                'stretch_web_teleop_provail.action.MoveToPregrasp_Result')
            logger.debug(
                'Failed to import needed modules for type support:\n' +
                traceback.format_exc())
        else:
...
class Metaclass_MoveToPregrasp_Feedback(type):
    ...
    def __import_type_support__(cls):
        try:
            ...
            import traceback
            logger = logging.getLogger(
                'stretch_web_teleop_provail.action.MoveToPregrasp_Feedback')
            logger.debug(
                'Failed to import needed modules for type support:\n' +
                traceback.format_exc())
        else:
...
class Metaclass_MoveToPregrasp_SendGoal_Request(type):
    ...
    def __import_type_support__(cls):
        try:
            ...
            from stretch_web_teleop_provail.action import MoveToPregrasp
...
class MoveToPregrasp_SendGoal_Request(metaclass=Metaclass_MoveToPregrasp_SendGoal_Request):
    ...
    _fields_and_field_types = {
        ...
        'goal': 'stretch_web_teleop_provail/MoveToPregrasp_Goal',
    }

    SLOT_TYPES = (
        rosidl_parser.definition.NamespacedType(['unique_identifier_msgs', 'msg'], 'UUID'),  # noqa: E501
        rosidl_parser.definition.NamespacedType(['stretch_web_teleop_provail', 'action'], 'MoveToPregrasp_Goal'),  # noqa: E501
    )
    ...
    def __init__(self, **kwargs):
        ...
        from stretch_web_teleop_provail.action._move_to_pregrasp import MoveToPregrasp_Goal
...
class Metaclass_MoveToPregrasp_SendGoal(type):
    ...
    def __import_type_support__(cls):
        try:
            ...
            import traceback
            logger = logging.getLogger(
                'stretch_web_teleop_provail.action.MoveToPregrasp_SendGoal')
            logger.debug(
                'Failed to import needed modules for type support:\n' +
                traceback.format_exc())
        else:
            ...
            from stretch_web_teleop_provail.action import _move_to_pregrasp
...
class MoveToPregrasp_SendGoal(metaclass=Metaclass_MoveToPregrasp_SendGoal):
    from stretch_web_teleop_provail.action._move_to_pregrasp import MoveToPregrasp_SendGoal_Request as Request
    from stretch_web_teleop_provail.action._move_to_pregrasp import MoveToPregrasp_SendGoal_Response as Response
...
class MoveToPregrasp_GetResult_Response(metaclass=Metaclass_MoveToPregrasp_GetResult_Response):
    ...
    _fields_and_field_types = {
        'status': 'int8',
        'result': 'stretch_web_teleop_provail/MoveToPregrasp_Result',
    }

    SLOT_TYPES = (
        rosidl_parser.definition.BasicType('int8'),  # noqa: E501
        rosidl_parser.definition.NamespacedType(['stretch_web_teleop_provail', 'action'], 'MoveToPregrasp_Result'),  # noqa: E501
    )
    ...
    def __init__(self, **kwargs):
        assert all('_' + key in self.__slots__ for key in kwargs.keys()), \
            ...
            ', '.join(sorted(k for k in kwargs.keys() if '_' + k not in self.__slots__))
        self.status = kwargs.get('status', int())
        from stretch_web_teleop_provail.action._move_to_pregrasp import MoveToPregrasp_Result
...
class Metaclass_MoveToPregrasp_GetResult(type):
    ...
    def __import_type_support__(cls):
        try:
            ...
            import traceback
            logger = logging.getLogger(
                'stretch_web_teleop_provail.action.MoveToPregrasp_GetResult')
            logger.debug(
                'Failed to import needed modules for type support:\n' +
                traceback.format_exc())
        else:
...
class MoveToPregrasp_GetResult(metaclass=Metaclass_MoveToPregrasp_GetResult):
    from stretch_web_teleop_provail.action._move_to_pregrasp import MoveToPregrasp_GetResult_Request as Request
    from stretch_web_teleop_provail.action._move_to_pregrasp import MoveToPregrasp_GetResult_Response as Response
...
class Metaclass_MoveToPregrasp_FeedbackMessage(type):
    ...
    def __import_type_support__(cls):
        try:
            ...
            import traceback
            logger = logging.getLogger(
                'stretch_web_teleop_provail.action.MoveToPregrasp_FeedbackMessage')
            logger.debug(
                'Failed to import needed modules for type support:\n' +
                traceback.format_exc())
        else:
...
class MoveToPregrasp_FeedbackMessage(metaclass=Metaclass_MoveToPregrasp_FeedbackMessage):
    ...
    _fields_and_field_types = {
        'goal_id': 'unique_identifier_msgs/UUID',
        'feedback': 'stretch_web_teleop_provail/MoveToPregrasp_Feedback',
    }

    SLOT_TYPES = (
        rosidl_parser.definition.NamespacedType(['unique_identifier_msgs', 'msg'], 'UUID'),  # noqa: E501
        rosidl_parser.definition.NamespacedType(['stretch_web_teleop_provail', 'action'], 'MoveToPregrasp_Feedback'),  # noqa: E501
    )
    ...
    def __init__(self, **kwargs):
        ...
        from unique_identifier_msgs.msg import UUID
        self.goal_id = kwargs.get('goal_id', UUID())
        from stretch_web_teleop_provail.action._move_to_pregrasp import MoveToPregrasp_Feedback
...
class Metaclass_MoveToPregrasp(type):
    ...
    def __import_type_support__(cls):
        try:
            ...
            import traceback
            logger = logging.getLogger(
                'stretch_web_teleop_provail.action.MoveToPregrasp')
            logger.debug(
                'Failed to import needed modules for type support:\n' +
                traceback.format_exc())
        else:
...
class MoveToPregrasp(metaclass=Metaclass_MoveToPregrasp):
    ...
    from stretch_web_teleop_provail.action._move_to_pregrasp import MoveToPregrasp_Goal as Goal
    # The result message defined in the action definition.
    from stretch_web_teleop_provail.action._move_to_pregrasp import MoveToPregrasp_Result as Result
    # The feedback message defined in the action definition.
    from stretch_web_teleop_provail.action._move_to_pregrasp import MoveToPregrasp_Feedback as Feedback

    class Impl:

        # The send_goal service using a wrapped version of the goal message as a request.
        from stretch_web_teleop_provail.action._move_to_pregrasp import MoveToPregrasp_SendGoal as SendGoalService
        # The get_result service using a wrapped version of the result message as a response.
        from stretch_web_teleop_provail.action._move_to_pregrasp import MoveToPregrasp_GetResult as GetResultService
        # The feedback message with generic fields which wraps the feedback message.
        from stretch_web_teleop_provail.action._move_to_pregrasp import MoveToPregrasp_FeedbackMessage as FeedbackMessage
