...
from stretch_web_teleop_provail_helpers.constants import (
    Frame,
    Joint,
...
from stretch_web_teleop_provail_helpers.conversions import (
...
from stretch_web_teleop_provail_helpers.move_to_pregrasp_state import MoveToPregraspState
from stretch_web_teleop_provail_helpers.stretch_ik_control import (
...
class MoveToPregraspNode(Node):
    ...
    def __init__(
        ...
        urdf_fpaths = uu.generate_ik_urdfs(
            "stretch_web_teleop_provail", rigid_wrist_urdf=False
        )
